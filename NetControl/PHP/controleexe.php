...
<?php
   ...
   function Atualiza() {
      ...
      if (filter_var($_POST['valorki'], FILTER_VALIDATE_FLOAT) === 0.0 || !filter_var($_POST['valorki'], FILTER_VALIDATE_FLOAT) === false)
      {
      ...
      if (filter_var($_POST['valorkd'], FILTER_VALIDATE_FLOAT) === 0.0 || !filter_var($_POST['valorkd'], FILTER_VALIDATE_FLOAT) === false)
      {
