...
<?php
   ...
   popen("/var/www/html/IoT_2DOF_CL.sh", "r");
...
<html>
	...
	<form method="post" action="CL_exe.php">
            <div class = "columnA">
                <h2>Control Yaw</h2>
                <input type="number" min="0" max="100" step="0.1" value="<?php echo $result['ajuste_0'] ?>" name="ajuste"
	                   for="power" oninput="power.value=ajuste.value" style="width: 98%; font-size:1em; text-align:right;" >
                <p></p>
            </div>

	  <input type="range" min="0" max="100"  step="0.1" value="<?php echo $result['ajuste_0'] ?>" name="power" list="powers"
	...
	<form method="post" action="CL2_exe.php">
            <div class = "columnA">
                <h2>Control Pitch</h2>
                <input type="number" min="0" max="100" step="0.1" value="<?php echo $result2['ajuste_1'] ?>" name="ajuste"
	                   for="power" oninput="power.value=ajuste.value" style="width: 98%; font-size:1em; text-align:right;" >
                <p></p>
            </div>

	  <input type="range" min="0" max="100"  step="0.1" value="<?php echo $result2['ajuste_1'] ?>" name="power" list="powers"
	         style="height:25%; width:100%; float:center;"
	         for="ajuste" oninput="ajuste.value=power.value" >
