...
def main(): 
  ...
  while True:
    ...
    csr.execute("INSERT INTO dados (ajuste, velocidade, erro, Kp, Ki, Kd, Kmotor, tempo) VALUES(?,?,?,?,?,?,?,?)",(desejadavelocidade, velocidade,pwm,fatorK,fatorKi,fatorKd, KVelocidade,xstamp))
    conn.commit()
