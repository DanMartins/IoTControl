...
import threading
import os
from AppControl import C_2DOF_LQR
...
controle=C_2DOF_LQR(K0_0, K0_1, K0_2, K0_3, K0_4, K0_5, K1_0, K1_1, K1_2, K1_3, K1_4, K1_5)
    ...
    while True:
      ...
      if (tempociclo <= (masterClock - tempoLoop)):
        ...
        if (tempoStorage <= (masterClock - tempoGrava)):
          ...
          csr.execute('SELECT ajuste_0, ajuste_1, "K0_0", "K0_1", "K0_2", "K0_3", "K0_4", "K0_5", "K1_0", "K1_1", "K1_2", "K1_3", "K1_4", "K1_5" FROM kgainmatrix')
          resstr = csr.fetchone()
          ...
          # input Param
          controle.setParam(K0_0,K0_1,K0_2,K0_3,K0_4,K0_5, K1_0,K1_1,K1_2,K1_3,K1_4,K1_5)
          # input saturation.
          controle.setLimit(Motor_MAX_Duty)
