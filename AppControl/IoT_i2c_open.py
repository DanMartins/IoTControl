      ...
      if (tempociclo <= (masterClock - tempoLoop)):
        ...
        if (tempoStorage <= (masterClock - tempoGrava)):
          ...
          if MCP4725 or PCF8591:
            csr.execute("INSERT INTO dados (ajuste, velocidade, erro, Kp, Ki, Kd, Kmotor, tempo) VALUES(?,?,?,?,?,?,?,?)",(dSetpoint, VT_Speed, AO1,fatorKp,fatorKi,fatorKd, 0.0,xstamp))
          else:
